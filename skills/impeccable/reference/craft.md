...
Discuss the feature with the user to establish a design brief. Clarify:
- What is being built and why
- Who will use it and in what context
- What the key states are (default, empty, error, loading)
- Any aesthetic constraints or preferences
...
Based on the design brief's needs, consult the relevant impeccable reference files. At minimum, always consult:
